    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h2 class="sub-header">Tambah Data Mobil</h2>
          <?php echo form_open_multipart('admincontroller/createcar') ?>
          <table>
            <tr>
              <td>
                <input type="text" class="form-control" name="merk_mobil" placeholder="Merk Mobil" size="50">
              </td>
            </tr>
            <tr>
              <td>
                <input type="text" class="form-control" name="tipe_mobil" placeholder="Tipe Mobil" size="50">
              </td>
            </tr>
            <tr>
              <td>
                <input type="text" class="form-control" name="tahun" placeholder="Tahun Mobil" size="50">
              </td>
            </tr>
            <tr>
              <td>
                <input type="text" class="form-control" name="kapasitas" placeholder="Kapasitas" size="50">
              </td>
            </tr>
            <tr>
              <td>
                <input type="text" class="form-control" name="harga" placeholder="Harga Sewa" size="50">
              </td>
            </tr>
            <tr>
              <td>
                <input type="text" class="form-control" name="platnomor" placeholder="Platnomor" size="50">
              </td>
            </tr>
            <tr>
              <td>
                <input type="file" name="gambar" class="btn btn-warning">
              </td>
            </tr>
            <tr>
              <td>
