  ...
  ================================================== -->
    <body>
            ...
            <div class="container">
              ...
              <div id="navbar" class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                  <li><?php echo anchor('membercontroller/home','Beranda')?></li>
                  <li class="active"><?php echo anchor('membercontroller/kendaraan','Kendaraan')?></li>
      ...
      <div class="container marketing">
        ...
        <?php echo form_open('membercontroller/proses') ?>
            ...
            <table class="table table-striped">
              ...
              <tbody>
                <tr>
                  ...
                  <td><?php echo $getUser['no_telp'] ?></td>
                  <td><?php echo $getUser['alamat'] ?></td>
                </tr>
              </tbody>
            </table>
          </div>
          <div class="table-responsive" style="float:left;margin-left: 548px;margin-top: -212px;">
            <table class="table table-striped">
              <thead>
                <tr>
                  <th>Merk</th>
              ...
              <tbody>
                <tr>
                  <td><input type="text" name="merk_mobil" value="<?php echo $showDetail['merk_mobil'] ?>" style="border:none;background: #F9F9F9;width:86px;" readonly="readonly"/></td>
                  <td><?php echo $showDetail['tipe_mobil'] ?></td>
                  <td><?php echo $showDetail['tahun'] ?></td>
                  <td><?php echo $showDetail['kapasitas'] ?></td>
                  <td><input type="text" name="harga" value="<?php echo $showDetail['harga'] ?>" style="border:none;background: #F9F9F9;width:86px;" readonly="readonly"/></td>
                  <td><input type="text" name="platnomor" value="<?php echo $showDetail['platnomor'] ?>" style="border:none;background: #F9F9F9;width:86px;" readonly="readonly"/></td>
                </tr>
              </tbody>
            </table>
            <table>
              <tr>
                <td>
                  <input type="text" class="form-control" name="lama_sewa" placeholder="Lama Sewa"/><br>
                  <input type="submit" value="Proses" class="btn btn-primary btn-xs"/>
                </td>
              </tr>
            </table>
          </div>
